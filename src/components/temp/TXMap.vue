...
export default {
  ...
  mounted() {
    ...
    TXMap.init().then((TXMap) => {
      ...
      this.TXMap = TXMap;
      if( this.coordinate || this.$route.query.coordinate){

       let coordinate=this.coordinate?this.coordinate.split(","):this.$route.query.coordinate?this.$route.query.coordinate.split(","):[]
