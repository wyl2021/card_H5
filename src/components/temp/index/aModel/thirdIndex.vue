...
export default {
  ...
  // created() {
  //   console.log("12312",this.$store.state.image1)
  //   // console.log("page1", localStorage.getItem("page1"));
  //   // let list= localStorage.getItem("page1");
  //   // console.log("page1列表",list)
  // },
  mounted(){
    this.getPage()
  },
  ...
  methods:{
    getPage(){
      const params = { button: localStorage.getItem("page1")};
      axios
