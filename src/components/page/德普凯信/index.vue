<template>
  <div class="p-page">
          ...
          <div class="pm">
            <div class="text4">
              <van-image
                :src="
                  cardId + 1 == 4
                    ? IMG + 'dpkx/icon/phone2.png'
                    : IMG + 'dpkx/icon/phone.png'
                "
              />{{ userInfo.phone }}
            </div>
            <div class="text5">
              <van-image
                :src="
                  cardId + 1 == 4
                    ? IMG + 'dpkx/icon/email2.png'
                    : IMG + 'dpkx/icon/email.png'
                "
              />{{ userInfo.email }}
            </div>
            <div class="text6">
              <van-image
                :src="
                  cardId + 1 == 4
                    ? IMG + 'dpkx/icon/address2.png'
                    : IMG + 'dpkx/icon/address.png'
                "
              />
    ...
    <!-- "userInfo.address" -->
    <pAddress
      phoneButton="dpkx/icon/phoneButton.png"
      addressButton="dpkx/icon/addressButton.png"
      :phone="userInfo.phone"
      address="宁波市海曙区灵桥路768号芝士公园3楼"
      name="德普凯信"
      :type="1"
    ></pAddress>
    <!-- 二维码和形象照 -->
    <pQrcode :isWx="userInfo.wx_code" qrCodeIcon="dpkx/icon/sys.png"></pQrcode>
    <!-- tab栏 -->
    <tab
      :tabList="tabList"
      :tabId="tabId"
      ...
      color="#6EBB54"
    ></tab>
  <dpkxIndexContent  ref="content" :list="list"></dpkxIndexContent>
    <!-- 阿库标识 -->
    <aKuLogo></aKuLogo>
  </div>
</template>
...
/deep/ .confirmButton {
  background-color: #6ebb54 !important;
}
/deep/ .line {
  background-color: #6ebb54 !important;
}
.selectCard {
  border: 1px solid #6ebb54 !important;
  border-radius: 8px;
}
