...
export default {
  ...
  data() {
    return {
      ...
      show: false,
      list: [],
      text: "Jeep宁波（江北店） Jeep品牌宁波、台州、温州、舟山总代理。 十余年专营Jeep汽车品牌老店，已为数万车主提供服务。 以汽车销售为中心，开展汽车服务、越野文化开发，改装、汽车文旅，户外露营等业务。 拥有华东区唯一获得国家地理认证的越野路线-龙极之径。 合作运营有东钱湖上水露营区·马山营地，东钱湖沙滩营地等多个户外营地。",
      whList: [
        {
          url: "zxbl/icon/1.png",
          name: "品牌定位",
