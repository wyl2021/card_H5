<template>
  <div class="p-page">
    ...
    >
      <template #userInfo>
        <div :class="'header' + (cardId + 1)" @click="show = true">
          <div class="post">
            <div class="name">
              <div class="text1" @click.stop="getIsName">{{ userInfo.name }}</div>
            </div>
            <div
              class="text3"
          ...
          <div class="pm">
            ...
            <div class="text6">
              <van-image
                ...
                "
              />
              <div class="textccc">{{ userInfo.address || "浙江省宁波市江北区风华路201号" }}</div>
            </div>
          </div>
        </div>
      </template>
    ...
    <pAddress
      ...
      :address=" userInfo.address || '浙江省宁波市江北区风华路201号 东校区'"
      coordinate="29.91278,121.61507"
      name="宁波工程学院"
      :type="1"
    ></pAddress>
    <!-- 二维码和形象照 -->
