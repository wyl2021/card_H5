...
function(t) {
    ...
    function e(e) {
        return this.each(function() {
            ...
            n || i.data("bs.stage", n = new o(this, s)),
            "string" == typeof e && n[e]()
        })
    }
    ...
    o.prototype.open = function() {
        var e = this;
        return t(document.body).css("overflow", "hidden"),
        "ontouchstart" in document.documentElement && t(document).on("touchmove.bs.stage",
        function(t) {
            t.preventDefault()
        }),
        t(this.options.hiddenElements).removeClass("hidden"),
        t(window).one("keydown.bs.stage", t.proxy(function(t) {
            27 == t.which && this.close()
        },
        this)),
        t(this.element).on("click.bs.stage", t.proxy(this.close, this)).trigger("open.bs.stage").addClass("stage-open"),
        t.support.transition ? (t(this.element).css({
    ...
    o.prototype.close = function() {
        function e() {
            ...
            "ontouchstart" in document.documentElement && t(document).off("touchmove.bs.stage"),
            t(i.options.hiddenElements).addClass("hidden"),
            t(i.element).removeClass("stage-open").css({
                "-webkit-transition": "",
                "-ms-transition": "",
                transition: ""
            }).css({
    ...
    var n = t.fn.stage;
    t.fn.stage = e,
    t.fn.stage.Constructor = o,
    t.fn.stage.noConflict = function() {
        return t.fn.stage = n,
        this
    },
    t(document).on("click", i,
    function() {
        var e = t(this).data(),
        i = t(this.getAttribute("data-target"));
        i.data("bs.stage") || i.stage(e),
        i.stage("toggle")
    })
} (jQuery);
